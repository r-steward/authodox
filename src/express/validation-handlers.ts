...
export class ValidationHandlersImpl implements AuthValidationHandlers {
    ...
    public readonly validateInitialUsernameAndPassword: ExpressLikeRequestHandler = async (req, _, next) => {
        // validate
    ...
    public readonly validateUsername: ExpressLikeRequestHandler = async (req, _, next) => {
        // validate
        const username = UsernameGetter(req);
    ...
    public readonly validatePassword: ExpressLikeRequestHandler = async (req, _, next) => {
        // validate
        const password = PasswordGetter(req);
