...
export class AuthHandlerImpl<P> implements AuthHandlers {
    ...
    public readonly authenticatePasswordClaim: ExpressLikeRequestHandler = async (req, _, next) => {
        // authenticate
    ...
    public readonly authenticateAccessTokenClaim: ExpressLikeRequestHandler = async (req, _, next) => {
        // authenticate
    ...
    public readonly authenticatePasswordResetClaim: ExpressLikeRequestHandler = async (req, _, next) => {
        // authenticate
    ...
    public readonly authenticateTokenRefreshClaim: ExpressLikeRequestHandler = async (req, _, next) => {
        // authenticate
    ...
    public readonly authenticateVerifyClaim: ExpressLikeRequestHandler = async (req, _, next) => {
        // authenticate
