 ...
 * @param password
 */
export const createPasswordAuthClaim = (
  user: string,
  password: string
): PasswordAuthClaim => ({
 ...
 * @param accessToken
 */
export const createAccessTokenAuthClaim = (
  accessToken: string
): AccessTokenAuthClaim => ({
 ...
 * @param refreshToken
 */
export const createRefreshAccessTokenAuthClaim = (
  refreshToken: string
): RefreshAccessTokenAuthClaim => ({
 ...
 * @param resetToken
 */
export const createPasswordResetAuthClaim = (
  resetToken: string
): PasswordResetAuthClaim => ({
 ...
 * @param verifyToken
 */
export const createVerifyUserAuthClaim = (
  verifyToken: string
): VerifyUserAuthClaim => ({
